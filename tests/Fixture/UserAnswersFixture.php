...
class UserAnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'result' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'question_id' => ['type' => 'index', 'columns' => ['question_id'], 'length' => []],
            'user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => ['user_id' => '191']],
            'user_test_id' => ['type' => 'index', 'columns' => ['user_test_id', 'answer_id'], 'length' => []],
        ],
        '_constraints' => [
