...
use App\Model\Table\MachineTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\MachineTypesTable Test Case
 */
class MachineTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\MachineTypesTable
     */
    public $MachineTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('MachineTypes') ? [] : ['className' => MachineTypesTable::class];
        $this->MachineTypes = TableRegistry::get('MachineTypes', $config);
    }
