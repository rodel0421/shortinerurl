...
<div class='box box-primary'>
    <div class='box-header'><h3 class='box-title'><i class="fa fa-book" aria-hidden="true"></i> <?= __('Edit Resource') ?></h3>
    	<div class="box-tools pull-right">
    	
        <?= $this->Html->link('Back', ['action' => 'view',$resource->id], 
