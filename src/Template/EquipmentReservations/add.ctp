...
<div class='box box-primary'>
    <div class='box-header'><h3 class='box-title'><?= __('Reserve Equipment') ?></h3>
...
<?php endif;?>
        ...
        <?php endforeach; ?>
            ...
            <span class='label label-danger' title='Available'>None Available</span>
        <div class="paginator">
        <ul class="pagination">
...
$(document).ready(function(){
    ...
    $(document).on('change', '.ajax-search', function(){
        url = "<?php echo $this->Url->build(array('action'=>'add',$user->id,'?'=>['filter'=>'1'])); ?>";
