...
<div class='box box-solid box-primary'>
    <div class='box-header'><h3 class='box-title'><?= ($dashboardItem->title) ? h($dashboardItem->title):  __('Trips: Requires Action')  ?></h3>
    ...
    <?= $this->Html->link('See All',['controller'=>'Trips','action'=>'index','filter'=>1,'Trips[status]'=>'Requires Action'])?>
    </div>
</div>