...
<div class='box box-solid box-primary'>
    <div class='box-header'><h3 class='box-title'><?= ($dashboardItem->title) ? h($dashboardItem->title):  __('Up coming Trips (2 weeks)')  ?></h3>
    ...
    <?= $this->Html->link('See All',['controller'=>'Trips','action'=>'index','filter'=>1,'date'=>'upcoming'])?>
    </div>
</div>