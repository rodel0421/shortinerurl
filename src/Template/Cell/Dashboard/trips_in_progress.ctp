...
<div class='box box-solid box-primary'>
    <div class='box-header'><h3 class='box-title'><?= ($dashboardItem->title) ? h($dashboardItem->title):  __('Trips in Progress')  ?></h3>
    ...
    <?= $this->Html->link('See All',['controller'=>'Trips','action'=>'index','filter'=>1,'date'=>'inprogress'])?>
    </div>
</div>