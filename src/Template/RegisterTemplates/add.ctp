...
<div class='box box-primary'>
    <div class='box-header'><h3 class='box-title'><?= __('Add Register Template') ?></h3>
    ...
    <?= $this->Form->create($registerTemplate); ?>
        <?php
            ...
            //echo $this->Form->input('form_type',['label'=>'Required Form','empty'=>'(None)','options'=>$formTemplates]);
