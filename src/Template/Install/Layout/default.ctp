...
if(!isset($app_logo_text)){
    $app_logo_text = '<span class="logo-mini"><b>D</b>AK</span><span class="logo-lg"><b>DAK</b>tech</span>';
}
...
<header class="main-header">
     <nav class="navbar navbar-static-top">
      <div class="container">
          ...
          <span class='client-name hidden-xs' style='cursor: default;' id='client_name'>DDMS Setup</span>
      </div>
     </nav>
</header>
