...
<p>We need to confirm that you are the owner of this email address.</p>
<p>To confirm, please click this 
    ...
    href="<?php echo $link; ?>">link</a> or copy and paste the link below into your browser:<br>
<p style="Margin:0;color:#2199e8;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none">
    <?php echo $link; ?></p></p>
<p>Thank you!</p>